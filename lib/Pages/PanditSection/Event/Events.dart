          ...
          children: [
            Padding(
              padding: EdgeInsets.only(
                  left: ResponsiveWidget.isSmallScreen(context) ? 0.0 : 25.0),
                                ...
                                return Column(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () {
                                        eventController.updateUpcoming(
                                            map[index]["bigS"],
                                            map[index]["youtube"],
                                            map[index]["puja"],
                                            map[index]["price"],
                                            ...
                                            map[index]["about"],
                                            map[index]["duration"],
                                            map[index]["total_days"],
                                            map[index]["participants"],
                                            map[index]["terms"]);
                                        Get.toNamed(
                                            '/eventDetail?event=$index');
                                      },
                                      child: Row(
                                        mainAxisAlignment:
                              ...
                              return Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    hoverColor: Colors.transparent,
                                    onTap: () {
                                      eventController.updatePrevious(
                                          map[index]["bigS"],
                                          map[index]["youtube"],
                                          map[index]["place"],
                                          map[index]["status"],
